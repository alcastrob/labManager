  ...
  <div>
    <b-modal ref="conformityModal" title="Declaración de Conformidad" hide-footer>
      ...
      <div class="modal-footer">
        ...
        <button v-if="!editing" class="btn btn-secondary" :disabled="warrantyPeriod === '' || $v.warrantyPeriod.$error" @click="createDeclarationOfConformity"><i class="fas fa-print mr-2 position-relative" style="top: 1px;"></i>Crear e imprimir</button>
