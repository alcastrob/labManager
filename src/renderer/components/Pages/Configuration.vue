    ...
    <div class="row">
      <div class="col-md-6 mt-3">
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.companyName.$model"
          id="companyName"
          ref="companyName"
          :class="{'is-invalid': $v.config.companyName.$error}"
        >
        <small class="text-danger" v-if="$v.config.companyName.$error">
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.makerNumber.$model"
          id="makerNumber"
          ref="makerNumber"
          :class="{'is-invalid': $v.config.makerNumber.$error}"
        >
        <small class="text-danger" v-if="$v.config.makerNumber.$error">
          Este valor es obligatorio
          <br>
        </small>
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.vatNumber.$model"
          id="vatNumber"
          ref="vatNumber"
          :class="{'is-invalid': $v.config.vatNumber.$error}"
        >
        <small class="text-danger" v-if="$v.config.vatNumber.$error">
          Este valor es obligatorio
          <br>
        </small>
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.sharedPath.$model"
          id="sharedPath"
          ref="sharedPath"
          :class="{'is-invalid': $v.config.sharedPath.$error}"
        >
        <small class="text-danger" v-if="$v.config.sharedPath.$error">
          Este valor es obligatorio
          <br>
        </small>
      </div>
      ...
      <div class="col-md-6 mt-3">
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.personInCharge.$model"
          id="personInCharge"
          ref="personInCharge"
          :class="{'is-invalid': $v.config.personInCharge.$error}"
        >
        <small class="text-danger" v-if="$v.config.personInCharge.$error">
          Este valor es obligatorio
          <br>
        </small>
        ...
        <input
          type="text"
          class="form-control"
          v-model="$v.config.invoiceFooter.$model"
          id="invoiceFooter"
          ref="invoiceFooter"
          :class="{'is-invalid': $v.config.invoiceFooter.$error}"
        >
        <small class="text-danger" v-if="$v.config.invoiceFooter.$error">
          Este valor es obligatorio
          <br>
        </small>
        ...
        <!--UPLOAD-->
        <logoFileUpload
          v-model="$v.config.logo.$model"
          :class="{'is-image-invalid': $v.config.logo.$error}"
        ></logoFileUpload>
        ...
        <small class="text-danger" v-if="$v.config.logo.$error">
          Este valor es obligatorio
          <br>
        </small>
      </div>
