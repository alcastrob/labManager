  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <p class="text-justify" v-if="!readOnly">
          <b>Nota:</b>Los descuentos que se introduzcan en esta tabla no serán permanentes hasta que se usen para generar una factura.
        </p>
        <p
          class="text-justify"
          v-else
