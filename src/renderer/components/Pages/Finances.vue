  ...
  <div>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        />
        <myIconCard
          :message="worksCountEndedLast30Days()"
        ...
        />
        <myIconCard
          :message="worksSumEndedLast30Days()"
        ...
        <div class="col-md-4">
          <div class="card mt-3">
            <div class="card-header">
              <h3 class="pt-2">
                Top 20
                <span class="small">(Últimos 12 meses)</span>
              </h3>
            </div>
              ...
              <div class="card mt-3">
                ...
                <div class="card-body">
                  ...
                  <button
                    ...
                    @click="gotoMonthCheck"
                  >Ir a página de cierre</button>
                </div>
                <!-- card-body -->
              </div>
              <!-- card -->
              ...
              <div class="card mt-3">
                ...
                <div class="card-body">
                  <invoiceExtendedTable
                    ...
                    ref="invoiceExtendedTable"
                    urlBase="/finances/invoices/"
                    masterKey="IdFactura"
                  ></invoiceExtendedTable>
                </div>
                <!-- card-body -->
...
export default {
	...
	methods: {
		...
		worksEndedThisMonth: function() {
			return (
				this.worksEndedThisMonthCount + ' trabajos cerrados en ' + new Date().toLocaleString('es-es', { month: 'long' })
			)
		},
		...
		worksSumEndedPrevious30Days: function() {
			return (
				this.moneyFormatter.format(this.worksEndedPrevious30daysSum) + ' por trabajos cerrados en los 30 días previos'
			)
		},
