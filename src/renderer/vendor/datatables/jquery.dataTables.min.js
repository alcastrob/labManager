...
(function (h) { typeof define === 'function' && define.amd ? define(['jquery'], function (E) { return h(E, window, document) }) : typeof exports === 'object' ? module.exports = function (E, H) { E || (E = window); H || (H = typeof window !== 'undefined' ? require('jquery') : require('jquery')(E)); return h(H, E, E.document) } : h(jQuery, window, document) })(function (h, E, H, k) {
  ...
  } function gb (a) { A(a, 'orderable', 'bSortable'); A(a, 'orderData', 'aDataSort'); A(a, 'orderSequence', 'asSorting'); A(a, 'orderDataType', 'sortDataType'); var b = a.aDataSort; typeof b === 'number' && !h.isArray(b) && (a.aDataSort = [b]) } function hb (a) {
    if (!n.__browser) {
  ...
  function ib (a, b, c, d, e, f) { var g, j = !1; c !== k && (g = c, j = !0); for (;d !== e;)a.hasOwnProperty(d) && (g = j ? b(g, a[d], d, a) : a[d], j = !0, d += f); return g } function Ea (a, b) { var c = n.defaults.column, d = a.aoColumns.length, c = h.extend({}, n.models.oColumn, c, {nTh: b || H.createElement('th'), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : '', aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.mData : d, idx: d}); a.aoColumns.push(c); c = a.aoPreSearchCols; c[d] = h.extend({}, n.models.oSearch, c[d]); ka(a, d, h(b).data()) } function ka (a, b, c) {
    var b = a.aoColumns[b],
      d = a.oClasses, e = h(b.nTh); if (!b.sWidthOrig) { b.sWidthOrig = e.attr('width') || null; var f = (e.attr('style') || '').match(/width:\s*(\d+[pxem%]+)/); f && (b.sWidthOrig = f[1]) }c !== k && c !== null && (gb(c), J(n.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h.extend(b, c), F(b, c, 'sWidth', 'sWidthOrig'), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), F(b, c, 'aDataSort')); var g = b.mData, j = S(g), i = b.mRender
...
a.nTable.nextSibling; for (var f = a.sDom.split(''), g, j, i, m, l, q, k = 0; k < f.length; k++) {
      g = null; j = f[k]; if (j == '<') { i = h('<div/>')[0]; m = f[k + 1]; if (m == "'" || m == '"') { l = ''; for (q = 2; f[k + q] != m;)l += f[k + q], q++; l == 'H' ? l = b.sJUIHeader : l == 'F' && (l = b.sJUIFooter); l.indexOf('.') != -1 ? (m = l.split('.'), i.id = m[0].substr(1, m[0].length - 1), i.className = m[1]) : l.charAt(0) == '#' ? i.id = l.substr(1, l.length - 1) : i.className = l; k += q }e.append(i); e = h(i) } else if (j == '>')e = e.parent(); else if (j == 'l' && d.bPaginate && d.bLengthChange)g = pb(a); else if (j == 'f' &&
d.bFilter)g = qb(a); else if (j == 'r' && d.bProcessing)g = rb(a); else if (j == 't')g = sb(a); else if (j == 'i' && d.bInfo)g = tb(a); else if (j == 'p' && d.bPaginate)g = ub(a); else if (n.ext.feature.length !== 0) { i = n.ext.feature; q = 0; for (m = i.length; q < m; q++) if (j == i[q].cFeature) { g = i[q].fnInit(a); break } }g && (i = a.aanFeatures, i[j] || (i[j] = []), i[j].push(g), e.append(g))
...
b.error || b.sError; c && K(a, 0, c); a.json = b; i(b)
  ...
  } function ta (a, b) { var c = h.isPlainObject(a.ajax) && a.ajax.dataSrc !== k ? a.ajax.dataSrc : a.sAjaxDataProp; return c === 'data' ? b.aaData || b[c] : c !== '' ? S(c)(b) : b } function qb (a) {
    ...
    var d = a.oPreviousSearch, e = a.aoPreSearchCols, f = function (a) { d.sSearch = a.sSearch; d.bRegex = a.bRegex; d.bSmart = a.bSmart; d.bCaseInsensitive = a.bCaseInsensitive }; Ga(a); if (y(a) != 'ssp') {
      xb(a, b.sSearch, c, b.bEscapeRegex !== k ? !b.bEscapeRegex : b.bRegex, b.bSmart, b.bCaseInsensitive); f(b); for (b = 0; b < e.length; b++) {
        yb(a, e[b].sSearch, b, e[b].bEscapeRegex !== k ? !e[b].bEscapeRegex : e[b].bRegex,
    ...
    var d = Pa(b,
        d, e, f), f = a.oPreviousSearch.sSearch, g = a.aiDisplayMaster, j, e = []; n.ext.search.length !== 0 && (c = !0); j = Ab(a); if (b.length <= 0)a.aiDisplay = g.slice(); else { if (j || c || f.length > b.length || b.indexOf(f) !== 0 || a.bSorted)a.aiDisplay = g.slice(); b = a.aiDisplay; for (c = 0; c < b.length; c++)d.test(a.aoData[b[c]]._sFilterRow) && e.push(b[c]); a.aiDisplay = e }
  } function Pa (a, b, c, d) {
    ...
    var b = a.sTableId, c = a.aanFeatures.i, d = h('<div/>', {'class': a.oClasses.sInfo, id: !c ? b + '_info' : null}); c || (a.aoDrawCallback.push({fn: Db, sName: 'information'}), d.attr('role', 'status').attr('aria-live', 'polite'), h(a.nTable).attr('aria-describedby',
      b + '_info')); return d[0]
  } function Db (a) { var b = a.aanFeatures.i; if (b.length !== 0) { var c = a.oLanguage, d = a._iDisplayStart + 1, e = a.fnDisplayEnd(), f = a.fnRecordsTotal(), g = a.fnRecordsDisplay(), j = g ? c.sInfo : c.sInfoEmpty; g !== f && (j += ' ' + c.sInfoFiltered); j += c.sInfoPostFix; j = Eb(a, j); c = c.fnInfoCallback; c !== null && (j = c.call(a.oInstance, a, d, e, f, g, j)); h(b).html(j) } } function Eb (a, b) {
...
'0'; a.childNodes[0].style.overflow = 'hidden'; a.style.width = Ua[b]
    ...
    var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner, j = c.length, i = ma(a, 'bVisible'), m = h('th', a.nTHead), l = b.getAttribute('width'), k = b.parentNode, t = !1, n, o, p = a.oBrowser, d = p.bScrollOversize; (n = b.style.width) && n.indexOf('%') !== -1 && (l = n); for (n = 0; n < i.length; n++)o = c[i[n]], o.sWidth !== null && (o.sWidth = Fb(o.sWidthOrig, k), t = !0); if (d ||
...
c; b++)j = h[b], j.formatter && g++, Ib(a, j.col); if (y(a) != 'ssp' && h.length !== 0) {
      ...
      this.fnPageChange = function (a, b) { var c = this.api(!0).page(a); (b === k || b) && c.draw(!1) }; this.fnSetColumnVis = function (a, b, c) { a = this.api(!0).column(a).visible(b); (c === k || c) && a.columns.adjust().draw() }; this.fnSettings = function () { return ya(this[x.iApiIndex]) }; this.fnSort = function (a) { this.api(!0).order(a).draw() }; this.fnSortListener = function (a, b, c) { this.api(!0).order.listener(a, b, c) }; this.fnUpdate = function (a, b, c, d, e) {
        ...
        var e = {}, g = d > 1 ? Xa(e, a, !0) : a, j = 0, i, e = this.getAttribute('id'), m = !1, l = n.defaults, q = h(this); if (this.nodeName.toLowerCase() != 'table')K(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2); else {
          fb(l); gb(l.column); J(l, l, !0); J(l.column, l.column, !0); J(l, h.extend(g, q.data())); var t = n.settings,
            ...
            sInstance: e,
            sTableId: e}); p.nTable = this; p.oApi = b.internal; p.oInit = g; t.push(p); p.oInstance = b.length === 1 ? b : q.dataTable(); fb(g); Ca(g.oLanguage); g.aLengthMenu && !g.iDisplayLength && (g.iDisplayLength = h.isArray(g.aLengthMenu[0]) ? g.aLengthMenu[0][0] : g.aLengthMenu[0]); g = Xa(h.extend(!0, {}, l), g); F(p.oFeatures, g, 'bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth bSortClasses bServerSide bDeferRender'.split(' ')); F(p, g, ['asStripeClasses', 'ajax', 'fnServerData', 'fnFormatNumber', 'sServerMethod',
          ...
          z(p, 'aoDrawCallback', g.fnDrawCallback, 'user'); z(p, 'aoServerParams', g.fnServerParams, 'user'); z(p, 'aoStateSaveParams', g.fnStateSaveParams, 'user'); z(p, 'aoStateLoadParams', g.fnStateLoadParams, 'user'); z(p, 'aoStateLoaded', g.fnStateLoaded, 'user'); z(p, 'aoRowCallback', g.fnRowCallback, 'user'); z(p, 'aoRowCreatedCallback', g.fnCreatedRow, 'user'); z(p, 'aoHeaderCallback', g.fnHeaderCallback, 'user'); z(p, 'aoFooterCallback', g.fnFooterCallback, 'user'); z(p, 'aoInitComplete', g.fnInitComplete, 'user'); z(p, 'aoPreDrawCallback',
            ...
            t =
g.aoColumns
          }j = 0; for (i = t.length; j < i; j++)Ea(p, e ? e[j] : null); jb(p, g.aoColumnDefs, t, function (a, b) { ka(p, a, b) }); if (x.length) { var w = function (a, b) { return a.getAttribute('data-' + b) !== null ? b : null }; h(x[0]).children('th, td').each(function (a, b) { var c = p.aoColumns[a]; if (c.mData === a) { var d = w(b, 'sort') || w(b, 'order'), e = w(b, 'filter') || w(b, 'search'); if (d !== null || e !== null) { c.mData = {_: a + '.display', sort: d !== null ? a + '.@data-' + d : k, type: d !== null ? a + '.@data-' + d : k, filter: e !== null ? a + '.@data-' + e : k}; ka(p, a) } } }) } var U = p.oFeatures,
            e = function () {
...
isFinite(a) ? b : null
    }, Pb = function (a, b) { Za[b] || (Za[b] = RegExp(Qa(b), 'g')); return typeof a === 'string' && b !== '.' ? a.replace(/\./g, '').replace(Za[b], '.') : a }, $a = function (a, b, c) { var d = typeof a === 'string'; if (M(a)) return !0; b && d && (a = Pb(a, b)); c && d && (a = a.replace(Ya, '')); return !isNaN(parseFloat(a)) && isFinite(a) }, Qb = function (a, b, c) { return M(a) ? !0 : !(M(a) || typeof a === 'string') ? null : $a(a.replace(Aa, ''), b, c) ? !0 : null }, D = function (a, b, c) {
...
0) return k; var a = this.context[0], b = a._iDisplayStart, c = a.oFeatures.bPaginate ? a._iDisplayLength : -1, d = a.fnRecordsDisplay(), e = c === -1; return {page: e ? 0 : Math.floor(b / c), pages: e ? 1 : Math.ceil(d / c), start: b, end: a.fnDisplayEnd(), length: c, recordsTotal: a.fnRecordsTotal(), recordsDisplay: d, serverSide: y(a) === 'ssp'}
  }); o('page.len()', function (a) { return a === k ? this.context.length !== 0 ? this.context[0]._iDisplayLength : k : this.iterator('table', function (b) { Ra(b, a) }) }); var Tb = function (a, b, c) {
    if (c) {
      var d = new s(a)
  ...
  }; o('ajax.json()', function () { var a = this.context; if (a.length > 0) return a[0].json }); o('ajax.params()', function () { var a = this.context; if (a.length > 0) return a[0].oAjaxData }); o('ajax.reload()', function (a, b) { return this.iterator('table', function (c) { Tb(c, !1 === b, a) }) }); o('ajax.url()', function (a) {
    var b =
...
k && a.row !== k && h.inArray(a.row, g) !== -1 ? [a] : []
    ...
    } kb(b[0], c[0].row, c[0].column, a); da(b[0], c[0].row, 'data', c[0].column); return this
...
this.context; return a.length ? a[0].oInit : null
  ...
  }); n.version = '1.10.19'; n.settings = []; n.models = {}; n.models.oSearch = {bCaseInsensitive: !0, sSearch: '', bRegex: !1, bSmart: !0}; n.models.oRow = {nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: '', src: null, idx: -1}; n.models.oColumn = {idx: null,
    aDataSort: null,
    asSorting: null,
    bSearchable: null,
    bSortable: null,
...
s + ']').focus()
  }}}); h.extend(n.ext.type.detect, [function (a, b) { var c = b.oLanguage.sDecimal; return $a(a, c) ? 'num' + c : null }, function (a) { if (a && !(a instanceof Date) && !Zb.test(a)) return null; var b = Date.parse(a); return b !== null && !isNaN(b) || M(a) ? 'date' : null }, function (a, b) { var c = b.oLanguage.sDecimal; return $a(a, c, !0) ? 'num-fmt' + c : null }, function (a, b) { var c = b.oLanguage.sDecimal; return Qb(a, c) ? 'html-num' + c : null }, function (a, b) { var c = b.oLanguage.sDecimal; return Qb(a, c, !0) ? 'html-num-fmt' + c : null }, function (a) {
    return M(a) ||
typeof a === 'string' && a.indexOf('<') !== -1 ? 'html' : null
  }]); h.extend(n.ext.type.search, {html: function (a) { return M(a) ? a : typeof a === 'string' ? a.replace(Nb, ' ').replace(Aa, '') : '' }, string: function (a) { return M(a) ? a : typeof a === 'string' ? a.replace(Nb, ' ') : a }}); var za = function (a, b, c, d) { if (a !== 0 && (!a || a === '-')) return -Infinity; b && (a = Pb(a, b)); a.replace && (c && (a = a.replace(c, '')), d && (a = a.replace(d, ''))); return 1 * a }; h.extend(x.type.order, {'date-pre': function (a) { a = Date.parse(a); return isNaN(a) ? -Infinity : a },
    'html-pre': function (a) {
      return M(a)
...
'asc' ? d.sSortJUIAsc : h[e] == 'desc' ? d.sSortJUIDesc : c.sSortingClassJUI)
  ...
  }}}); var eb = function (a) { return typeof a === 'string' ? a.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;') : a }; n.render = {number: function (a, b, c, d, e) {
    return {display: function (f) {
      if (typeof f !== 'number' && typeof f !== 'string') return f; var g = f < 0 ? '-' : '', h = parseFloat(f); if (isNaN(h)) return eb(f); h = h.toFixed(c); f = Math.abs(h); h = parseInt(f, 10); f = c ? b + (f - h).toFixed(c).substring(2) : ''; return g + (d || '') + h.toString().replace(/\B(?=(\d{3})+(?!\d))/g,
        a) + f + (e || '')
    }}
  },
  text: function () { return {display: eb, filter: eb} }}; h.extend(n.ext.internal, {_fnExternApiFunc: Mb,
    _fnBuildAjax: sa,
    _fnAjaxUpdate: mb,
